...
suite&mdash;specifically the rv32i tests. It assumes that the following repositories
have been cloned to `c:\git`

&nbsp;&nbsp;&nbsp;&nbsp;[github.com/riscv/riscv-test-env](github.com/riscv/riscv-test-env)

&nbsp;&nbsp;&nbsp;&nbsp;[github.com/riscv/riscv-tests](github.com/riscv/riscv-tests)
...
&nbsp;&nbsp;&nbsp;&nbsp;[sysprogs.com/getfile/1107/risc-v-gcc10.1.0.exe](sysprogs.com/getfile/1107/risc-v-gcc10.1.0.exe)

The `make` executable used was that from msys 1.0.

&nbsp;&nbsp;&nbsp;&nbsp;[downloads.sourceforge.net/mingw/MSYS-1.0.11.exe](downloads.sourceforge.net/mingw/MSYS-1.0.11.exe)
...
the test will appear in this folder as a `.exe` (e.g. `addi.exe`), and can be run
